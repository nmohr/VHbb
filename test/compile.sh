...
g++ -q -o fit_sideband_pt50To100 SideBandAnalysis-Pt50To100/fit_sideband.cxx -I $ROOTSYS/include -I $ROOFITSYS/include -L $ROOFITSYS/lib -l RooFit -l RooFitCore -L $ROOTSYS/lib `root-config --glibs`
