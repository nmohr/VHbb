...
g++ -o make_histos_Pt50To100 SideBandAnalysis-Pt50To100/make_histos_sideband.cxx -I $ROOTSYS/include -lMathMore -I $ROOTSYS/include/TMVA -l TMVA -L $ROOTSYS/lib `root-config --glibs`
