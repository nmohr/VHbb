...
xsecs1 = [3048]*3
Aprefix1 = ['udscg_120_', 'b_120_','c_120_']
...
xsecs2 = [30]*3
Aprefix2 = ['udscg_120_', 'b_120_','c_120_']
...
for i in range(1,len(InFiles0)):
    copytree(pathIN,pathOUT,prefix,InFiles0[i],Aprefix0[0],cut0[0])
...
for i in range(3):
    #copytree(pathIN,pathOUT,prefix,InFiles1[i],Aprefix1[i],cut1[i])
...
for i in range(3):
    #copytree(pathIN,pathOUT,prefix,InFiles2[i],Aprefix2[i],cut2[i])
...
for i in range(0,len(dataFiles)):
    #copytree(pathIN,pathOUT,prefix,dataFiles[i],AdataPrefix[0],datacuts[i])
