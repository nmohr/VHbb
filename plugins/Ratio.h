...
std::vector<TH1*> make_rebinned_ratios(TH1* theHist, TH1* theReference, double maxUncertainty, bool useReferenceError = false)
{
  std::vector<TH1*> hist;
  ...
  if (lastBin <= firstBin)  return hist;     // no content
