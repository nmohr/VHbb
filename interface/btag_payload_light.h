...
float mistag_CSVT(float eta,float x, float scale) {
  ...
  if(scale > 0)     return mean + (max-mean)*scale *1.5 * 1.19275 + -0.00191042*x + 2.92205e-06*x*x;
  if(scale< 0)     return mean + (mean-min)*scale*1.5 *  1.19275 + -0.00191042*x + 2.92205e-06*x*x;
